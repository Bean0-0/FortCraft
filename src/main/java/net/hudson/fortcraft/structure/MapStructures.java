package net.hudson.fortcraft.structure;

import com.mojang.serialization.Codec;
import com.mojang.serialization.codecs.RecordCodecBuilder;
import net.hudson.fortcraft.ModStructures;
...
public class MapStructures extends Structure {

    // A custom codec that changes the size limit for our code_structure_sky_fan.json's config to not be capped at 7.
    // With this, we can have a structure with a size limit up to 30 if we want to have extremely long branches of pieces in the structure.
    public static final Codec<MapStructures> CODEC = RecordCodecBuilder.<MapStructures>mapCodec(instance ->
            instance.group(MapStructures.settingsCodec(instance),
            ...
            ).apply(instance, MapStructures::new)).codec();
    ...
    public MapStructures(Structure.StructureSettings config,
    ...
    private static boolean extraSpawningChecks(Structure.GenerationContext context) {
        ...
        return chunkpos.getMinBlockX() == 0 && chunkpos.getMinBlockZ() == 0;
    }
    ...
    public Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext context) {
        ...
        if (!MapStructures.extraSpawningChecks(context)) {
    ...
    public StructureType<?> type() {
        return ModStructures.MAP_STRUCTURES.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}