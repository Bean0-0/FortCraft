...
public class SmgGunItem extends ProjectileWeaponItem implements Vanishable {

    public SmgGunItem(Properties pProperties) {
        super(pProperties);
    }
                ...
                if (!itemstack.isEmpty() || flag) {
                    ...
                    if (!((double) f < 0.1D)) {
                        ...
                        if (!pLevel.isClientSide) {
                            ...
                            f *= 3.0F;
                            abstractarrow.shootFromRotation(pPlayer, pPlayer.getXRot(), pPlayer.getYRot(), 0.0F, 2F, 5.0F);
                            abstractarrow.setBaseDamage(0.9f);
