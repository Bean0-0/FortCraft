...
public class SniperGunItem extends ProjectileWeaponItem implements Vanishable {

    public SniperGunItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    private final int fire_rate = 240;
        ...
        if (!itemstack.isEmpty() || flag) {
            ...
            if (!((double) f < 0.1D)) {
                ...
                if (!pLevel.isClientSide) {
                    ...
                    f *= 3.0F;
                    abstractarrow.shootFromRotation(pPlayer, pPlayer.getXRot(), pPlayer.getYRot(), 0.0F, 20F, 0F);
                    abstractarrow.setBaseDamage(15f);
