scoreboard players remove @e[tag=ccar_wheel,distance=..6,tag=ccar7] ccarwheel 23
...
scoreboard players set @e[tag=ccar_wheel,distance=..6,tag=ccar7,scores={ccarwheel=..-1}] ccarwheel 360
execute if entity @s[scores={ccarspeed=1..2}] if block ^ ^1.5 ^0.25 #ccars115_gshn28:nonsolid as @e[tag=ccar,distance=..6,tag=ccar7] at @s run tp @s ^ ^ ^0.1
execute if entity @s[scores={ccarspeed=3..4}] if block ^ ^1.5 ^0.25 #ccars115_gshn28:nonsolid as @e[tag=ccar,distance=..6,tag=ccar7] at @s run tp @s ^ ^ ^0.2
execute if entity @s[scores={ccarspeed=5..6}] if block ^ ^1.5 ^0.25 #ccars115_gshn28:nonsolid as @e[tag=ccar,distance=..6,tag=ccar7] at @s run tp @s ^ ^ ^0.3
execute if entity @s[scores={ccarspeed=7..8}] if block ^ ^1.5 ^0.25 #ccars115_gshn28:nonsolid as @e[tag=ccar,distance=..6,tag=ccar7] at @s run tp @s ^ ^ ^0.4
execute if entity @s[scores={ccarspeed=9..10}] if block ^ ^1.5 ^0.25 #ccars115_gshn28:nonsolid as @e[tag=ccar,distance=..6,tag=ccar7] at @s run tp @s ^ ^ ^0.5
