scoreboard players add @e[tag=ccar_wheel,distance=..6,tag=ccar9] ccarwheel 17
...
scoreboard players set @e[tag=ccar_wheel,distance=..6,tag=ccar9,scores={ccarwheel=361..}] ccarwheel 1
execute if entity @s[scores={ccarspeed=-2..-1}] if block ^ ^1.5 ^-0.25 #ccars115_gshn28:nonsolid as @e[tag=ccar,distance=..6,tag=ccar9] at @s run tp @s ^ ^ ^-0.1
execute if entity @s[scores={ccarspeed=-4..-3}] if block ^ ^1.5 ^-0.25 #ccars115_gshn28:nonsolid as @e[tag=ccar,distance=..6,tag=ccar9] at @s run tp @s ^ ^ ^-0.2
execute if entity @s[scores={ccarspeed=-6..-5}] if block ^ ^1.5 ^-0.25 #ccars115_gshn28:nonsolid as @e[tag=ccar,distance=..6,tag=ccar9] at @s run tp @s ^ ^ ^-0.3
