summon armor_stand ~3 ~-1 ~-9 {CustomNameVisible:0b,Tags:["Ccar8"],NoGravity:1b,Invulnerable:1b,Invisible:0b,PersistenceRequired:1b,CustomName:"{\"text\":\"CCar_Scanner\"}"}
